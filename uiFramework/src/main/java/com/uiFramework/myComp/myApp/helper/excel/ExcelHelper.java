package com.uiFramework.myComp.myApp.helper.excel;
...
public class ExcelHelper {
	...
	public static void main(String[] args) {
	 ...
	 Object[][] data = excelHelper.getExcelData(excelLocation, "SearchData");
//	 System.out.println(data);
//	 excelHelper.updateResult(excelLocation, "status-update", "Login", "PASS");
//	 excelHelper.updateResult(excelLocation, "status-update", "Registration", "FAIL");
//	 excelHelper.updateResult(excelLocation, "status-update", "Add to Cart", "PASS");
